...
def put(path: str) -> requests.models.Response:
    ...
    """
    ENCRYPTED_GITHUB_TOKEN = os.environ.get["GITHUB_TOKEN"]
    DECRYPTED_GITHUB_TOKEN = boto3.client('kms').decrypt(CiphertextBlob=b64decode(ENCRYPTED_GITHUB_TOKEN))['Plaintext']
